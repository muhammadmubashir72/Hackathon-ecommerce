...
//   return (
//     <div className="border-x-2 border-y-4 border-gray-300 rounded-lg hover:shadow-lg  h-auto bg-gray-100 my-4 mx-3 relative">
//       <div className="relative">
//         {/* Icons */}
//         <div className="absolute top-2 right-0 flex flex-col space-y-2 mr-2">
//           <div
...
//         />
//         <Link href={card.detailsLink}>
//           <div className="w-[260px] h-auto flex flex-col justify-evenly my-5 space-y-2 px-6">
//             <h5
//               className={`${montserrat.className} text-start font-bold text-[16px] text-myDark `}
//             >
//               {card.heading}
...
//             <div className="w-[108px] h-auto flex flex-col justify-start">
//               <div>
//                 <h5
//                   className={`${montserrat.className} text-start font-bold text-[18px] text-myDarkGreen `}
//                 >
...
//             <button
//               onClick={navigate}
//               className="items-center bg-black text-white text-sm md:text-lg font-medium py-2 px-4 md:py-3 md:px-6 rounded-lg shadow-lg"
//             >
//               View Product
//             </button>
//           </div>
