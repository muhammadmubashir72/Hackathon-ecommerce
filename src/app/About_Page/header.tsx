...
export default function Header() {
  ...
  return (
    <div className="w-full">
      {/* Navbar Light */}
      <div className="w-full px-4 sm:px-8 md:px-1 lg:px-4 py-4 lg:bg-white bg-black/5">
        <div className="flex items-center justify-between">
          ...
          <div className=" hidden md:flex items-center space-x-5 lg:space-x-14">
            ...
            <div className="w-[200px] h-[42px] lg:w-[214px] lg:h-[52px] flex rounded-md bg-myBlue">
              <button className="w-[200px] h-[42px] lg:w-[214px] lg:h-[52px]  bg-myBlue text-white font-bold  rounded-[5px] text-smhover:text-black ">
                Become a member
              </button>
