...
// import convertToSubcurrency from "@/app/";
...
const CheckoutPage = ({ amount }: { amount: number }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="bg-white p-2 rounded-md">
      ...
      <button
      onClick={()=>{
        router.push("/success"); // Redirect to success page after Cash on Delivery
      }}
        disabled={!stripe || loading}
        className="text-white w-full p-5 bg-myBlue mt-2 rounded-md font-bold disabled:opacity-50 disabled:animate-pulse"
      >
